(function () {
	'use strict';
	angular.module('app')
		.controller('PromotionsController', ['$scope', '$location', '$http', '$q', 'formationService', 'promotionService', 'EtudiantsService', '$modal', '$rootScope', function ($scope, $location, $http, $q, formationService, promotionService, EtudiantsService, $modal, $rootScope) {
